...
namespace SaltInvoice\Controllers;
...
use SaltInvoice\Models\Settings;
...
{
    protected $modelNamespace = 'SaltInvoice';
    ...
    public function index(Request $request) {
        ...
        try {
            ...
            $count = $this->model->where('group', 'invoice_categories')->count();
            $model = $this->model->where('group', 'invoice_categories')->filter();
