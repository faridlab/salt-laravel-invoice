...
namespace SaltInvoice\Providers;

use Illuminate\Support\ServiceProvider;

class SaltInvoiceServiceProvider extends ServiceProvider
{
    /**
    ...
    public function boot()
    {
         ...
         */
        $this->publishes([
            __DIR__.'/../../config/salt-laravel-invoice.php' => config_path('salt-laravel-invoice.php'),
        ], 'config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-invoice');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'salt-laravel-invoice');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/salt-laravel-invoice'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'salt-laravel-invoice');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/salt-laravel-invoice'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \SaltInvoice\Console\Commands\SaltInvoiceCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/salt-laravel-invoice'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/salt-laravel-invoice.php', 'salt-laravel-invoice'
        // );
    }
}
